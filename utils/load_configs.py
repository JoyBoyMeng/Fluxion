...
def get_link_prediction_args(is_evaluation: bool = False):
    ...
    parser.add_argument('--model_name', type=str, default='DyGFormer', help='name of the model, note that EdgeBank is only applicable for evaluation',
                        choices=['JODIE', 'DyRep', 'TGAT', 'TGN', 'TGN-id', 'CAWN', 'EdgeBank', 'TCL', 'GraphMixer', 'DyGFormer'])
...
def load_node_classification_best_configs(args: argparse.Namespace):
    """
    load the best configurations for the popularity prediction task
    :param args: argparse.Namespace
    :return:
    """
    # model specific settings
...
def get_popularity_prediction_args():
    ...
    parser.add_argument('--dataset_name', type=str, help='dataset to be used', default='aminer', choices=['aminer', 'yelp'])
    parser.add_argument('--batch_size', type=int, default=200, help='batch size')
    parser.add_argument('--model_name', type=str, default='DyGFormer', help='name of the model',
...
def load_popularity_prediction_best_configs(args: argparse.Namespace):
    """
    load the best configurations for the popularity prediction task
    :param args: argparse.Namespace
    :return:
