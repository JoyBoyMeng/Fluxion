...
from models.modules import PopularityPredictor
...
if __name__ == "__main__":
    ...
    for run in range(args.num_runs):
        ...
        args.seed = run
        args.load_model_name = f'popularity_prediction_{args.model_name}_seed{args.seed}'
        args.save_result_name = f'evaluate_popularity_prediction_{args.model_name}_seed{args.seed}'
